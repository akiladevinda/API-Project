...
//Create API LINKS
var MAIN_API = _CONFIG_.GET_OLASCRIPT_DETAILS_URL;


export default class OlaScripts extends Component{
  ...
  function_GetBooksDetails(user_email){
    ...
    fetch(MAIN_API, {
      ...
      .catch((error) => {
        MAIN_API = _CONFIG_.GET_OLASCRIPT_DETAILS_URL_BACKUP;
        this.function_GetBooksDetails(user_email);
      });
  ...
  render() {
    ...
    <View>
        <TouchableOpacity style={styles.drawerIcon} onPress= {this.handleBackButtonClick}>
            ...
            <Text style={styles.headerTextMain}>Ola Scripts</Text>
        ...
        renderRow={(service) => {
          return (
            <View style={styles.box}>
              <Image style={styles.image} source={{uri: service.Ola_Image}} />
              <View style={styles.boxContent}>
                <Text style={styles.title}>{service.Ola_Name}</Text>
                <Text style={styles.description}>{service.Ola_Publish_Year}</Text>
              </View>
            </View>
          )
        }}/> }
