  ...
  render() {
    ...
    <View>
        <TouchableOpacity style={styles.drawerIcon} onPress= {this.handleBackButtonClick}>
            ...
            <Text style={styles.headerTextMain}>Government Publications</Text>
        ...
        renderRow={(service) => {
          return (
            <View style={styles.box}>
              <Image style={styles.image} source={{uri: service.Gov_Image}} />
              <View style={styles.boxContent}>
                <Text style={styles.title}>{service.Gov_Name}</Text>
                <Text style={styles.description}>{service.Gov_Publish_Date}</Text>
              </View>
            </View>
          )
        }}/> }
